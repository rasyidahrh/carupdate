                        ...
                        <table id="myTable" class="display compact" style="width:100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <a href="process/process_hapusdevisi.php?id_devisi=' . $d["id_devisi"] . '" data-id="' . $d["id_devisi"] . '" data-toggle="modal" data-target="#exampleModal" <button class="btn btn-danger"><i class="fas fa-fw fa-trash"></i></a>
                                </td>';
                                        } else {
                                            echo '';
                                        }
