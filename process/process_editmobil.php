...
if (!empty($_FILES['foto']['name'])) {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        if ($ukuran < 1044070) {
            ...
            $query = mysqli_query($koneksi, "update mobil set plat_nomer='$platnomer',merek='$merek',tipe_mobil='$tipe',warna='$warna',BBM='$BBM',foto='$namaFile' where id='$id'");
            if ($query) {
    ...
    $query = mysqli_query($koneksi, "update mobil set plat_nomer='$platnomer',merek='$merek',tipe_mobil='$tipe',warna='$warna',BBM='$BBM' where id='$id'");
